...
# Read x and y from standard input, as strings.
x = stdio.readString()
y = stdio.readString()
...
# Note that the value opt[i][j] represents the optimal edit distance
# between the string x[i:] and y[j:].
...
# Compute the rest of opt, starting at opt[M - 1][N - 1] and ending
# at opt[0][0].
